...
username = "${SEC_USERNAME}"   # Username
password = "${SEC_PASSWORD}"   # Password
...
username = "${SEC_USERNAME}"               # Use HTTP Basic authentication
password = "${SEC_PASSWORD}"               # Use HTTP Basic authentication
